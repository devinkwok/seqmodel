...
class ProteinBertModel(nn.Module):
    ...
    def forward(self, tokens, repr_layers=[], need_head_weights=False, return_contacts=False):
        ...
        # if token_dropout==True set masked position embedding vectors to 0
        # and scale remaining vectors by number of masked positions
        ...
        # only set attention mask if at least 1 position is padding
        ...
        # linear layer decoding for output
        if self.model_version == 'ESM-1b':
